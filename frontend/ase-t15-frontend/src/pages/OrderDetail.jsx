	...
	return order_id_is_valid? (
		<div className="orderDetailContainer" scroll="no">
			...
			<div className="orderDetailCaptionContainer">
				...
				<div className="orderDetailCaptionOrder">{order}</div>
			</div>
			...
			<div className="bottomContainer">
				<div className="orderDetailTextContainer">
					<div className="orderDetailTextCaption">Order Details</div>
					<div className="orderDetailTextParagraph">Customer Name: {customer_name}</div>
					<div className="orderDetailTextParagraph">Order: {order}</div>
					<div className="orderDetailTextParagraph">Vendor: {vendor}</div>
					<div className="orderDetailTextParagraph">Order Date: {order_date}</div>
				</div>
				
				<div className="orderDetailHistoryContainer">
